...
class RandomEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COCKTAIL_RECIPE_TEST_RANDOM_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def random_basic_setup(extra)
  ...
  entid_env_raw = ENV["COCKTAIL_RECIPE_TEST_RANDOM_ENTID"]
