...
#      offline in seeded test mode (CocktailRecipeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CocktailRecipe_sdk.rb")
  SDK_CLASS = "CocktailRecipeSDK"
