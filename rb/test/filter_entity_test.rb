...
class FilterEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COCKTAILRECIPE_TEST_FILTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def filter_basic_setup(extra)
  ...
  entid_env_raw = ENV["COCKTAILRECIPE_TEST_FILTER_ENTID"]
