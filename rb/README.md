...
The Ruby SDK for the CocktailRecipe API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.CocktailRecipe(nil).load(
  { "id" => "test01" }, nil
)
