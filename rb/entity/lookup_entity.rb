...
class LookupEntity
  ...
  #
  # @param reqmatch [LookupListMatch, Hash, nil] match filter (any subset of
  #   Lookup fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Lookup>, Array] the matching Lookup items; raises CocktailRecipeError on failure
