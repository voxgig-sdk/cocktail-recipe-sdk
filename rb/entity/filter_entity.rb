...
class FilterEntity
  ...
  #
  # @param reqmatch [FilterListMatch, Hash, nil] match filter (any subset of
  #   Filter fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Filter>, Array] the matching Filter items; raises CocktailRecipeError on failure
