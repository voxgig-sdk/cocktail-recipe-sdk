...
func NewFilterEntity(client *core.CocktailRecipeSDK, entopts map[string]any) *FilterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FilterEntity) GetName() string { return e.name }
...
func (e *FilterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FilterEntity) Deleted() bool {
	return e.deleted
}


func (e *FilterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFilterEntity(e.client, opts)
}

func (e *FilterEntity) Data(args ...any) any {
...
func (e *FilterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Filter; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FilterEntity) DataTyped(data ...Filter) Filter {
	if len(data) > 0 {
		return typedFrom[Filter](e.Data(asMap(data[0])))
	}
	return typedFrom[Filter](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Filter (all fields
// optional at the wire level).
func (e *FilterEntity) MatchTyped(match ...Filter) Filter {
	if len(match) > 0 {
		return typedFrom[Filter](e.Match(asMap(match[0])))
	}
	return typedFrom[Filter](e.Match())
}
...
func (e *FilterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FilterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FilterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FilterListMatch and returns []Filter. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FilterEntity) ListTyped(reqmatch FilterListMatch, ctrl map[string]any) ([]Filter, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Filter](res), nil
}



func (e *FilterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FilterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FilterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FilterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
