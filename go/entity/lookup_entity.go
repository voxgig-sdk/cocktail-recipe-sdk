...
func NewLookupEntity(client *core.CocktailRecipeSDK, entopts map[string]any) *LookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
