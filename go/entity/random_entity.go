...
func NewRandomEntity(client *core.CocktailRecipeSDK, entopts map[string]any) *RandomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RandomEntity) GetName() string { return e.name }
...
func (e *RandomEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RandomEntity) Deleted() bool {
	return e.deleted
}


func (e *RandomEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRandomEntity(e.client, opts)
}

func (e *RandomEntity) Data(args ...any) any {
...
func (e *RandomEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *RandomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RandomEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RandomEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RandomListMatch and returns []Random. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RandomEntity) ListTyped(reqmatch RandomListMatch, ctrl map[string]any) ([]Random, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Random](res), nil
}



func (e *RandomEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RandomEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RandomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RandomEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
