...
func NewListEntity(client *core.CocktailRecipeSDK, entopts map[string]any) *ListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListEntity) GetName() string { return e.name }
...
func (e *ListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListEntity) Deleted() bool {
	return e.deleted
}


func (e *ListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListEntity(e.client, opts)
}

func (e *ListEntity) Data(args ...any) any {
...
func (e *ListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *ListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
