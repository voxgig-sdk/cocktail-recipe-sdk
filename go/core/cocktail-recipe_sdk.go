...
func (sdk *CocktailRecipeSDK) OptionsMap() map[string]any {
...
func (sdk *CocktailRecipeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CocktailRecipeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CocktailRecipeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CocktailRecipeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CocktailRecipeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CocktailRecipeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CocktailRecipeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CocktailRecipeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CocktailRecipeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CocktailRecipeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CocktailRecipeSDK {
	...
	sdk := NewCocktailRecipeSDK(sdkopts)
	sdk.Mode = "test"
