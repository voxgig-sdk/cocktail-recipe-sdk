...
|---|---|---|
| `ts/` | @voxgig-sdk/cocktail-recipe-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cocktail-recipe-sdk \
      --repository voxgig-sdk/cocktail-recipe-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cocktail-recipe-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cocktail-recipe-sdk --id=<id>` removes it.
