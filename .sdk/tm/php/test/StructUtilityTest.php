...
// CocktailRecipe SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CocktailRecipeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CocktailRecipeOmni::structfix($now, Struct::undef()))
                        !== json_encode(CocktailRecipeOmni::structfix($val, Struct::undef()))) {
