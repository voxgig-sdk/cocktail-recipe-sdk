...
// CocktailRecipe SDK utility type

class CocktailRecipeUtility
{
    ...
    public static function copy(CocktailRecipeUtility $src): CocktailRecipeUtility
    {
        $u = new CocktailRecipeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
