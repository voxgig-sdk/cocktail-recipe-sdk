...
// CocktailRecipe SDK utility: fetcher

class CocktailRecipeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CocktailRecipeSDK/1.0)';
    ...
    public static function call(CocktailRecipeContext $ctx, string $fullurl, array $fetchdef): array
    {
