...
// CocktailRecipe SDK utility: graphql
//
...
class CocktailRecipeGraphql
{
    ...
    // equivalent.
    public static function body(CocktailRecipeContext $ctx): mixed
    {
    ...
    public static function errors(CocktailRecipeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
