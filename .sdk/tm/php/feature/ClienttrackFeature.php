...
// CocktailRecipe SDK clienttrack feature
...
class CocktailRecipeClienttrackFeature extends CocktailRecipeBaseFeature
{
    ...
    public function PostConstruct(CocktailRecipeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CocktailRecipe-SDK';
