...
// CocktailRecipe SDK streaming feature
...
class CocktailRecipeStreamingFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _iterate(CocktailRecipeResult $result): \Generator
    {
    ...
    private function _streamable(CocktailRecipeContext $ctx): bool
    {
