...
// CocktailRecipe SDK idempotency feature
...
class CocktailRecipeIdempotencyFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _mutating(CocktailRecipeContext $ctx): bool
    {
