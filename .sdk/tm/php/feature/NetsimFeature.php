...
// CocktailRecipe SDK netsim feature
...
class CocktailRecipeNetsimFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _simulate(CocktailRecipeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CocktailRecipeContext $ctx, array $applied): void
    {
        $client = $this->client;
