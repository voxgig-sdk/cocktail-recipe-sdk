...
// CocktailRecipe SDK telemetry feature
...
class CocktailRecipeTelemetryFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _close(CocktailRecipeContext $ctx, bool $ok): void
    {
