...
// CocktailRecipe SDK cache feature
...
class CocktailRecipeCacheFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _through(CocktailRecipeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
