...
// CocktailRecipe SDK rbac feature
...
class CocktailRecipeRbacFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _required(CocktailRecipeContext $ctx): ?string
    {
    ...
    private function _reject(CocktailRecipeContext $ctx, string $required): void
    {
    ...
    private function _track(CocktailRecipeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
