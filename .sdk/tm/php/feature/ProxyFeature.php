...
// CocktailRecipe SDK proxy feature
...
class CocktailRecipeProxyFeature extends CocktailRecipeBaseFeature
{
    ...
    public function init(CocktailRecipeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CocktailRecipeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
