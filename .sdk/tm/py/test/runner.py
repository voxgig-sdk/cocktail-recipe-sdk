...
class CocktailRecipeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CocktailRecipeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CocktailRecipeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CocktailRecipeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
