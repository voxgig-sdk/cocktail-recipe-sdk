...
class CocktailRecipeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CocktailRecipeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CocktailRecipeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CocktailRecipeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
