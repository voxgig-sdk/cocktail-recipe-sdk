...
(0, node_test_1.describe)('ListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COCKTAIL_RECIPE_TEST_LIST_ENTID'];
...
//# sourceMappingURL=ListDirect.test.js.map