...
function envOverride(m) {
    if ('TRUE' === process.env.COCKTAIL_RECIPE_TEST_LIVE ||
        'TRUE' === process.env.COCKTAIL_RECIPE_TEST_OVERRIDE) {
    ...
    m.COCKTAIL_RECIPE_TEST_EXPLAIN = process.env.COCKTAIL_RECIPE_TEST_EXPLAIN || m.COCKTAIL_RECIPE_TEST_EXPLAIN;
    return m;
}
