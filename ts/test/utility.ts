...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.COCKTAILRECIPE_TEST_LIVE ||
    'TRUE' === process.env.COCKTAILRECIPE_TEST_OVERRIDE
  ) {
  ...
  m.COCKTAILRECIPE_TEST_EXPLAIN = process.env.COCKTAILRECIPE_TEST_EXPLAIN || m.COCKTAILRECIPE_TEST_EXPLAIN
