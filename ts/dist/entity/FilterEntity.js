...
class FilterEntity extends CocktailRecipeEntityBase_1.CocktailRecipeEntityBase {
    ...
    make() {
        return new FilterEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Filter[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=FilterEntity.js.map