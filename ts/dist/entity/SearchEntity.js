...
class SearchEntity extends CocktailRecipeEntityBase_1.CocktailRecipeEntityBase {
    ...
    make() {
        return new SearchEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Search[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
