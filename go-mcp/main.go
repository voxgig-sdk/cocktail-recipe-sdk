// Command CocktailRecipe-mcp is an MCP server exposing the CocktailRecipe
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CocktailRecipe_list  — list records of an entity
//	CocktailRecipe_load  — load a single record of an entity
//
