...
type Args struct {
	Entity string         `json:"entity" jsonschema:"filter | list | lookup | random | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CocktailRecipeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cocktail-recipe_list",
		Description: "List records from CocktailRecipe. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cocktail-recipe_load",
		Description: "Load a single record from CocktailRecipe. " +
...
func runOp(client *sdk.CocktailRecipeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CocktailRecipeSDK, name string) (sdk.CocktailRecipeEntity, error) {
