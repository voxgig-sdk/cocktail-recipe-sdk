...
local CocktailRecipeSDK = {}
CocktailRecipeSDK.__index = CocktailRecipeSDK
...
CocktailRecipeSDK._make_feature = _make_feature


function CocktailRecipeSDK.new(options)
  local self = setmetatable({}, CocktailRecipeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CocktailRecipeSDK:options_map()
...
function CocktailRecipeSDK:get_utility()
  return Utility.copy(self._utility)
end


function CocktailRecipeSDK:get_root_ctx()
  return self._rootctx
end


function CocktailRecipeSDK:prepare(fetchargs)
...
function CocktailRecipeSDK:direct(fetchargs)
...
-- by passing it.
function CocktailRecipeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CocktailRecipeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CocktailRecipeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CocktailRecipeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CocktailRecipeSDK.new(sdkopts)
  sdk.mode = "test"
