...
function runner.env_override(m)
  local live = runner.getenv("COCKTAIL_RECIPE_TEST_LIVE")
  local override = runner.getenv("COCKTAIL_RECIPE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COCKTAIL_RECIPE_TEST_EXPLAIN")
