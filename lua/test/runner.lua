...
function runner.env_override(m)
  local live = runner.getenv("COCKTAILRECIPE_TEST_LIVE")
  local override = runner.getenv("COCKTAILRECIPE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COCKTAILRECIPE_TEST_EXPLAIN")
