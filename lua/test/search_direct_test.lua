...
describe("SearchDirect", function()
  it("should direct-list-search", function()
    local setup = search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-search", setup.live and "live" or "unit")
