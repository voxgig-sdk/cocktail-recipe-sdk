...
describe("ListDirect", function()
  it("should direct-list-list", function()
    local setup = list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-list", setup.live and "live" or "unit")
...
function list_direct_setup(mockres)
