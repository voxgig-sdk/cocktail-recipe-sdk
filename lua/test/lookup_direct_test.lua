...
describe("LookupDirect", function()
  it("should direct-list-lookup", function()
    local setup = lookup_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-lookup", setup.live and "live" or "unit")
...
function lookup_direct_setup(mockres)
