...
local SDK_MODULE = "cocktail-recipe_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["filter"] = { ["test01"] = { id = "test01" } }, ["list"] = { ["test01"] = { id = "test01" } }, ["lookup"] = { ["test01"] = { id = "test01" } }, ["random"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
