...
describe("FilterDirect", function()
  it("should direct-list-filter", function()
    local setup = filter_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-filter", setup.live and "live" or "unit")
...
function filter_direct_setup(mockres)
