...
// CocktailRecipe SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CocktailRecipeTransformResponse
{
    public static function call(CocktailRecipeContext $ctx): mixed
    {
        ...
        $transform = CocktailRecipeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
