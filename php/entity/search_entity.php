...
class SearchEntity
{
     ...
     *
     * @param SearchListMatch|array|null $reqmatch Match filter (any subset
     *   of Search fields) as an assoc-array; SearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Search[]|array A list of Search items as assoc-arrays at
