...
The PHP SDK for the CocktailRecipe API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Filter(null)->list(null, null);
...
[$result, $err] = $client->CocktailRecipe(null)->load(
    ["id" => "test01"], null
);
