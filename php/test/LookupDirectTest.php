...
class LookupDirectTest extends TestCase
{
    public function test_direct_list_lookup(): void
    {
        $setup = lookup_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-lookup", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
