...
class ListDirectTest extends TestCase
{
    public function test_direct_list_list(): void
    {
        $setup = list_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
