...
class FilterDirectTest extends TestCase
{
    public function test_direct_list_filter(): void
    {
        $setup = filter_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-filter", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
