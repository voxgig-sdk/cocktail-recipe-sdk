...
// CocktailRecipe SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CocktailRecipeSDK::test)
...
{
    private const SDK_CLASS = 'CocktailRecipeSDK';
    ...
    private const SDK_BASE = 'cocktailrecipe_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../cocktailrecipe_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
