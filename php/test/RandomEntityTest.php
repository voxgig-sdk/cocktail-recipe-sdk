...
class RandomEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COCKTAIL_RECIPE_TEST_RANDOM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function random_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COCKTAIL_RECIPE_TEST_RANDOM_ENTID");
