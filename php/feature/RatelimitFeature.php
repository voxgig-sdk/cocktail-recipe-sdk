...
// CocktailRecipe SDK ratelimit feature
...
class CocktailRecipeRatelimitFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _acquire(CocktailRecipeContext $ctx): void
    {
    ...
    private function _track(CocktailRecipeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
