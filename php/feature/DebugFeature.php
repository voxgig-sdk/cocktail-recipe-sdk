...
// CocktailRecipe SDK debug feature
...
class CocktailRecipeDebugFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _finish(CocktailRecipeContext $ctx, bool $ok): void
    {
