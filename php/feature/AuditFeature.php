...
// CocktailRecipe SDK audit feature
...
class CocktailRecipeAuditFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _emit(CocktailRecipeContext $ctx, string $outcome): void
    {
