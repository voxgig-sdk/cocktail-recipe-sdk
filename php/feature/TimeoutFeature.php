...
// CocktailRecipe SDK timeout feature
...
class CocktailRecipeTimeoutFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _with_timeout(CocktailRecipeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CocktailRecipeContext $_ctx, float $ms): void
    {
        $client = $this->client;
