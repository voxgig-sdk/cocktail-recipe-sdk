...
// CocktailRecipe SDK metrics feature
...
class CocktailRecipeMetricsFeature extends CocktailRecipeBaseFeature
{
    ...
    private function _record(CocktailRecipeContext $ctx, bool $ok): void
    {
