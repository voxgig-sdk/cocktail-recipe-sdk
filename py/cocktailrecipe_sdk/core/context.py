...
from cocktailrecipe_sdk.core.control import CocktailRecipeControl
...
from cocktailrecipe_sdk.core.helpers import get_ctx_prop, to_map
...
class CocktailRecipeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CocktailRecipeControl()
        ...
        if isinstance(sp, CocktailRecipeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CocktailRecipeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CocktailRecipeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CocktailRecipeOperation({})
    ...
    def make_error(self, code, msg):
        return CocktailRecipeError(code, msg, self)
