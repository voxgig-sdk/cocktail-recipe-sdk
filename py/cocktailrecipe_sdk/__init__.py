...
from cocktailrecipe_sdk.utility import register

# Load features
from cocktailrecipe_sdk.feature.base_feature import CocktailRecipeBaseFeature
from cocktailrecipe_sdk.features import _has_feature, _make_feature
...
class CocktailRecipeSDK:
    ...
    def get_utility(self):
        return CocktailRecipeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CocktailRecipeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from cocktailrecipe_sdk.entity.random_entity import RandomEntity
        return RandomEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from cocktailrecipe_sdk.entity.search_entity import SearchEntity
