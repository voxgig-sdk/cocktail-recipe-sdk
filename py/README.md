# CocktailRecipe Python SDK



The Python SDK for the CocktailRecipe API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Filter()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/cocktail-recipe-sdk/releases)) or
...
```
py/
├── cocktailrecipe_sdk.py         -- Main SDK module
