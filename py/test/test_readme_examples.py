# CocktailRecipe SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CocktailRecipeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CocktailRecipeSDK(...) and CocktailRecipeSDK.test(...) become
#      CocktailRecipeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cocktailrecipe_sdk"
_SDK_CLASS = "CocktailRecipeSDK"
