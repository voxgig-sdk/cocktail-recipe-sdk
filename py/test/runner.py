...
class CocktailRecipeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CocktailRecipeTestRunner.getenv("COCKTAILRECIPE_TEST_LIVE")
        override = CocktailRecipeTestRunner.getenv("COCKTAILRECIPE_TEST_OVERRIDE")
        ...
        explain = CocktailRecipeTestRunner.getenv("COCKTAILRECIPE_TEST_EXPLAIN")
