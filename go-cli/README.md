...
AQL-driven CLI and REPL for the CocktailRecipe SDK. Positional arguments are
...
```sh
go build -o cocktail-recipe-cli ./...
```
...
./cocktail-recipe-cli load 1 filter
./cocktail-recipe-cli load '{id:1}' filter
