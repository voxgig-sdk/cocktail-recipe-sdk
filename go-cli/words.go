...
func registerSDKWords(r *eng.Registry, client *sdk.CocktailRecipeSDK) {
...
func runOp(client *sdk.CocktailRecipeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
